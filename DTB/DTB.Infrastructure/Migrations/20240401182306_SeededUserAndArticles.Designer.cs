...
namespace DTB.Infrastructure.Migrations
{
    ...
    [Migration("20240401182306_SeededUserAndArticles")]
    partial class SeededUserAndArticles
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DTB.Infrastructure.Data.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ac8bea30-f027-4e6b-94b5-4dedc5ebe704",
                            ...
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(2454),
                        ...
                        new
                        {
                            Id = "1eb518cf-4d21-426a-9c37-cb48e8fe5ffb",
                            AuthorId = "cad23a9b-e215-45e8-823f-87207f8c2b71",
                            ...
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(2460),
                        ...
                        new
                        {
                            Id = "7c81bc5e-37c5-48df-a215-acd9a2c97e59",
                            AuthorId = "cad23a9b-e215-45e8-823f-87207f8c2b71",
                            ...
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(2467),
                        ...
                        new
                        {
                            Id = "a2363fe6-5885-4af6-b16a-77607408f90b",
                            AuthorId = "cad23a9b-e215-45e8-823f-87207f8c2b71",
                            ...
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(2472),
                        ...
                        new
                        {
                            Id = "12c2dc5a-74e5-43b1-978e-462562a357b1",
                            AuthorId = "cad23a9b-e215-45e8-823f-87207f8c2b71",
                            ...
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(2477),
                        ...
                        new
                        {
                            Id = "6bafd97b-04dd-4557-b6e7-d9a377270fa1",
                            AuthorId = "cad23a9b-e215-45e8-823f-87207f8c2b71",
                            ...
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(2483),
            ...
            modelBuilder.Entity("DTB.Infrastructure.Data.Entities.BaseUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b878ba5b-7b9e-4493-b0cb-3b996e126fce",
                            Email = "test@abv.bg",
                            ...
                            SecurityStamp = "61073353-8935-46c9-9351-1bb57d8fc609",
            ...
            modelBuilder.Entity("DTB.Infrastructure.Data.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "2b8af1a0-aae3-4410-9cf4-a180cf6daa0d",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(1809),
                            Name = "Architecture, Construction",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824820/icon_architecture_gqdlbl.png"
                        },
                        new
                        {
                            Id = "04b24fd7-7eb9-467a-9000-03b5ad0a4b63",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(1858),
                            Name = "Health and Pharmacy",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824820/icon_health_nhktmm.png"
                        },
                        new
                        {
                            Id = "c7667ab7-bda4-45bc-bb2a-19e2b26d1cdb",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(1866),
                            Name = "Drivers, Couriers",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824821/icon_derivers_q8g7p3.png"
                        },
                        new
                        {
                            Id = "d8441c32-1802-47dc-a8e6-6b84af9f6659",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(1873),
                        ...
                        new
                        {
                            Id = "ee96eae7-1329-4b35-b106-ee288a5f166a",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(1880),
                        ...
                        new
                        {
                            Id = "ab54d1df-fcb7-4c0b-aa86-49243cb6d01a",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(1890),
                            Name = "Human Resources",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824820/icon_hr_jbc5jn.png"
                        },
                        new
                        {
                            Id = "64c4f882-97b2-43d5-8bb9-c376ecb90c7f",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(1894),
                            Name = "Media, Publishing",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824821/icon_media_mpzkez.png"
                        },
                        new
                        {
                            Id = "0cd06519-87a4-43cd-ad98-628b2ac58931",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(1913),
                            Name = "Logistics, Spedition",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824821/icon_logistic_ktvoqa.png"
                        },
                        new
                        {
                            Id = "b5243015-2dab-45d1-8a02-5fe94b6062e6",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(1921),
                            Name = "Customer support",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824820/icon_customersupport_fbvie5.png"
                        },
                        new
                        {
                            Id = "9b305282-62ee-4f8d-8165-cd92964eaf27",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(1931),
                        ...
                        new
                        {
                            Id = "bfdb2926-c5bb-48c2-a12d-a5cfb26341a0",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(1938),
                            Name = "Marketing, Advertising, PR",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824820/icon_hr_jbc5jn.png"
                        },
                        new
                        {
                            Id = "e418d12e-1c3a-4b1b-b85b-075293e9d4ab",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(1942),
                        ...
                        new
                        {
                            Id = "301c410c-1891-4fb3-9e17-40f1963f7fff",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(1945),
                        ...
                        new
                        {
                            Id = "a71cd58d-d2c5-431f-aa59-c1dab12f5b19",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(1949),
                        ...
                        new
                        {
                            Id = "8a1b162d-9149-4eb5-a9d3-4fd0e38cd9fc",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(1956),
                        ...
                        new
                        {
                            Id = "c17146a6-57da-45c3-b0a4-da36a808eba3",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(2036),
                            Name = "Security",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824825/icon_security_c4fjq0.png"
                        },
                        new
                        {
                            Id = "0ff496ae-42ed-4684-a0ca-b19445ecf696",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(2044),
                            Name = "Real-estate",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824821/icon_realestate_dkhhfe.png"
                        },
                        new
                        {
                            Id = "eea01812-80ac-420d-889a-bc3ab7f4b971",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(2052),
                            Name = "Legal",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824821/icon_legal_ofzofx.png"
                        },
                        new
                        {
                            Id = "bd5d90bb-b45d-43da-b2a5-18cbde65bfa0",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(2058),
                        ...
                        new
                        {
                            Id = "c66f545c-cbd7-4114-b597-07e68499752e",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(2064),
                            Name = "Auto Service",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824819/icon_autoservice_iabxkj.png"
                        },
                        new
                        {
                            Id = "ef399db7-7cbb-48d0-ab6e-83bce469ea69",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(2069),
                            Name = "Retail, Wholesale",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824824/icon_retail_pgicm9.png"
                        },
                        new
                        {
                            Id = "4f58a38d-e569-4468-9389-ec92bbe2c68e",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(2075),
                            Name = "Technical Support",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824825/icon_techsupport_zph0mx.png"
                        },
                        new
                        {
                            Id = "4e2c02fe-c17c-4af0-aa13-2c6779ebaf9d",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(2080),
                            Name = "Research and development",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824822/icon_research_mdrafi.png"
                        },
                        new
                        {
                            Id = "3d4e0875-c049-46cf-9558-187c3331128a",
                            DateOfCreation = new DateTime(2024, 4, 1, 21, 23, 4, 851, DateTimeKind.Local).AddTicks(2087),
            ...
            modelBuilder.Entity("DTB.Infrastructure.Data.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "5c88844b-b9d8-46f2-b95f-d9199b8e943d",
                            Name = "Sofia"
                        },
                        new
                        {
                            Id = "e39c6f15-369c-4b7e-92de-5a33d25b099c",
                            Name = "Burgas"
                        },
                        new
                        {
                            Id = "77de2f0e-77c4-4562-a764-b1c54eb2b8bc",
                            Name = "Plovdiv"
                        },
                        new
                        {
                            Id = "4c5a78cf-c46a-4477-af2e-2aca3e4aedbf",
                            Name = "Varna"
                        },
                        new
                        {
                            Id = "5a86c519-6db7-45dc-bac4-461a1b755a31",
                            Name = "Yambol"
                        },
                        new
                        {
                            Id = "bc12c9b1-9cea-4657-a89f-ca34f1d6b06e",
                            Name = "Blagoevgrad"
                        },
                        new
                        {
                            Id = "7fdc6a54-eea8-4595-bd19-d177b1f26387",
                            Name = "Sliven"
                        },
                        new
                        {
                            Id = "27ce8666-68da-4d5d-b9ff-57200d834b43",
                            Name = "Dimitrovgrad"
                        },
                        new
                        {
                            Id = "fd9de968-d08b-458c-9847-f72769761678",
                            Name = "Ruse"
                        },
                        new
                        {
                            Id = "f277a479-6540-49b6-ad30-edf9e7a7f40e",
                            Name = "Elhovo"
                        });
                });
