...
namespace DTB.Infrastructure.Migrations
{
    ...
    [Migration("20240408185327_SeededRoles")]
            ...
            modelBuilder.Entity("DTB.Infrastructure.Data.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "328fbb7d-30f0-45a1-a351-c31f237a7e92",
                            ...
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 413, DateTimeKind.Local).AddTicks(65),
                        ...
                        new
                        {
                            Id = "57e16c07-ba5c-4126-8e53-bc5e427c751c",
                            AuthorId = "cad23a9b-e215-45e8-823f-87207f8c2b71",
                            ...
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 413, DateTimeKind.Local).AddTicks(84),
                        ...
                        new
                        {
                            Id = "8ebf0955-3768-4ef8-a1ed-91e275553e4e",
                            AuthorId = "cad23a9b-e215-45e8-823f-87207f8c2b71",
                            ...
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 413, DateTimeKind.Local).AddTicks(97),
                        ...
                        new
                        {
                            Id = "0ee180df-553c-4687-9860-19da7f4e3a4d",
                            AuthorId = "cad23a9b-e215-45e8-823f-87207f8c2b71",
                            ...
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 413, DateTimeKind.Local).AddTicks(103),
                        ...
                        new
                        {
                            Id = "af85709a-0fa1-4399-869c-45706c48a9c1",
                            AuthorId = "cad23a9b-e215-45e8-823f-87207f8c2b71",
                            ...
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 413, DateTimeKind.Local).AddTicks(109),
                        ...
                        new
                        {
                            Id = "9b9a3337-2ce7-4054-a89e-add595eccd80",
                            AuthorId = "cad23a9b-e215-45e8-823f-87207f8c2b71",
                            ...
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 413, DateTimeKind.Local).AddTicks(115),
            ...
            modelBuilder.Entity("DTB.Infrastructure.Data.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "bc4f3bda-5f54-4a53-b9e1-897abd48237b",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(8821),
                            Name = "Architecture, Construction",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824820/icon_architecture_gqdlbl.png"
                        },
                        new
                        {
                            Id = "caf483c9-5fe7-4b1b-89be-4eade71eccb8",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(8919),
                            Name = "Health and Pharmacy",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824820/icon_health_nhktmm.png"
                        },
                        new
                        {
                            Id = "e2af5357-bb65-4982-b19c-75e91b001ddb",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(8928),
                            Name = "Drivers, Couriers",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824821/icon_derivers_q8g7p3.png"
                        },
                        new
                        {
                            Id = "b382492a-1769-4583-938b-164287b2dc91",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(8936),
                        ...
                        new
                        {
                            Id = "bf744c2a-dbbd-4037-9d6a-34f9991b5e5b",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(8942),
                        ...
                        new
                        {
                            Id = "080f3d17-4b08-4897-b51a-2cc6cfa34b03",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(8971),
                            Name = "Human Resources",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824820/icon_hr_jbc5jn.png"
                        },
                        new
                        {
                            Id = "e8f97ced-2551-4aaa-8c3e-ce8cd6a8a04b",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(8977),
                            Name = "Media, Publishing",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824821/icon_media_mpzkez.png"
                        },
                        new
                        {
                            Id = "cd4d379b-9127-4561-82f6-7dba3a08f236",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(8987),
                            Name = "Logistics, Spedition",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824821/icon_logistic_ktvoqa.png"
                        },
                        new
                        {
                            Id = "0953f89d-ed62-47dd-9299-a02aee358992",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(8991),
                            Name = "Customer support",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824820/icon_customersupport_fbvie5.png"
                        },
                        new
                        {
                            Id = "7be79430-719c-432c-9883-e13479703225",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(8999),
                        ...
                        new
                        {
                            Id = "bef242f6-2f93-44be-bebb-3e1ae41f3aa0",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(9007),
                            Name = "Marketing, Advertising, PR",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824820/icon_hr_jbc5jn.png"
                        },
                        new
                        {
                            Id = "624addc6-f91f-422b-9fdf-2f2192544f2e",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(9071),
                        ...
                        new
                        {
                            Id = "6d3473a0-2a71-4ccb-9d25-d987e2af3253",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(9076),
                        ...
                        new
                        {
                            Id = "51acfafe-b4b7-4a97-b9e2-8d3f6cf3ee42",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(9086),
                        ...
                        new
                        {
                            Id = "808bb046-41d6-4399-a272-6e07184dff2a",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(9094),
                        ...
                        new
                        {
                            Id = "cd8bfa52-e8ea-4b6f-a435-0e3beb944d29",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(9101),
                            Name = "Security",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824825/icon_security_c4fjq0.png"
                        },
                        new
                        {
                            Id = "8c0659b8-f80c-4b7b-b334-61a0a65fe02f",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(9110),
                            Name = "Real-estate",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824821/icon_realestate_dkhhfe.png"
                        },
                        new
                        {
                            Id = "e1cfbad7-7563-4f35-85e0-f1e32f8c3e66",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(9119),
                            Name = "Legal",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824821/icon_legal_ofzofx.png"
                        },
                        new
                        {
                            Id = "e22b5a04-d75c-441a-bdc2-eab7a2ce457f",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(9125),
                        ...
                        new
                        {
                            Id = "d4ade450-3d3f-424c-b9a5-7952844a5ce1",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(9132),
                            Name = "Auto Service",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824819/icon_autoservice_iabxkj.png"
                        },
                        new
                        {
                            Id = "9bbe696c-ff61-406e-9070-e2c35e2c8ea2",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(9138),
                            Name = "Retail, Wholesale",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824824/icon_retail_pgicm9.png"
                        },
                        new
                        {
                            Id = "a3d17596-33d7-4b22-a442-fbd140dd19b2",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(9145),
                            Name = "Technical Support",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824825/icon_techsupport_zph0mx.png"
                        },
                        new
                        {
                            Id = "b13db8bc-61d9-4dde-a17b-af8219ccde9c",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(9152),
                            Name = "Research and development",
                            PictureUrl = "https://res.cloudinary.com/dftfu5p0r/image/upload/v1709824822/icon_research_mdrafi.png"
                        },
                        new
                        {
                            Id = "2f134785-d1bc-49a3-a1d0-622be728ab00",
                            DateOfCreation = new DateTime(2024, 4, 8, 21, 53, 26, 412, DateTimeKind.Local).AddTicks(9158),
            ...
            modelBuilder.Entity("DTB.Infrastructure.Data.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "88677966-8f67-4085-b7a3-38a6b0c28dfb",
                            Name = "Sofia"
                        },
                        new
                        {
                            Id = "4240eb60-3bf2-450d-bad8-7f79af754b72",
                            Name = "Burgas"
                        },
                        new
                        {
                            Id = "9f8f7988-aa63-4cd9-845e-9608e4df68eb",
                            Name = "Plovdiv"
                        },
                        new
                        {
                            Id = "d5a22362-03c0-4687-aa45-cc7c4c50f6ed",
                            Name = "Varna"
                        },
                        new
                        {
                            Id = "9ec4b82a-a348-40eb-b034-34c238623381",
                            Name = "Yambol"
                        },
                        new
                        {
                            Id = "b812f64f-fdbe-4174-a6d2-2c19eddd9629",
                            Name = "Blagoevgrad"
                        },
                        new
                        {
                            Id = "5fb159c9-6b58-4ce5-adbe-9a4e8c6618e3",
                            Name = "Sliven"
                        },
                        new
                        {
                            Id = "11fb07cc-21cc-4dae-8e21-458eaa0515aa",
                            Name = "Dimitrovgrad"
                        },
                        new
                        {
                            Id = "3e2d7236-0c08-4c1e-9f4e-2d2a8d8fe741",
                            Name = "Ruse"
                        },
                        new
                        {
                            Id = "df1cdb62-0445-4d27-92e5-4af493bb014e",
                            Name = "Elhovo"
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "d5b59395-df5b-4364-abe9-63949e42258c",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "d527475a-42ef-4bcd-a77f-4958c9ceb290",
                            Name = "Company",
                            NormalizedName = "COMPANY"
                        },
                        new
                        {
                            Id = "5f9aa12e-5569-401b-930e-be2bf3279ab1",
                            Name = "Administrator",
            ...
            modelBuilder.Entity("DTB.Infrastructure.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e4f1905d-ce1a-474f-977f-ad46d9bd9777",
                            Email = "test@abv.bg",
                            ...
                            SecurityStamp = "d64764e8-d7ff-4074-bead-6924e19bab48",
